...
rast2-annotate-proteins-similarity 

=head1 SYNOPSIS

rast2-annotate-proteins-similarity [--input genome-file] [--output genome-file] [< genome-file] [> genome-file]
...
rast2-annotate-proteins-similarity [-io] [long options...] < input > output
