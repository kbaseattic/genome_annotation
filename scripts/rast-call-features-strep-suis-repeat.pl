...
rast-call-features-strep-suis-repeat

=head1 SYNOPSIS

rast-call-features-strep-suis-repeat [--input genome-file] [--output genome-file] [< genome-file] [> genome-file]
...
rast-call-features-strep-suis-repeat [-hio] [long options...] < input > output
