...
rast-annotate-proteins-kmer-v2 [--input genome-file] [--output genome-file] [< genome-file] [> genome-file]
...
my($opt, $usage) = describe_options("rast-annotate-proteins-kmer-v2 %o < input > output",
				    @options);
