...
rast-call-features-CDS-prodigal [--input genome-file] [--output genome-file] [< genome-file] [> genome-file]
...
my($opt, $usage) = describe_options("rast-call-features-CDS-prodigal %o < input > output",
				    @options);
