...
rast2-call-features-prophage-phispy

=head1 SYNOPSIS

rast2-call-features-prophage-phispy [--input genome-file] [--output genome-file] [< genome-file] [> genome-file]
...
rast2-call-features-prophage-phispy [-io] [long options...] < input > output
...
my($opt, $usage) = describe_options("rast2-call-features-prophage-phispy %o < input > output",
				    @options);
