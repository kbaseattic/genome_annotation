...
rast-call-features-rRNA-SEED [--call-5S] [--call-LSU] [--call-SSU] [--input genome-file] [--output genome-file] [< genome-file] [> genome-file]
...
rast-call-features-rRNA-SEED [-io] [long options...] < input > output
...
my($opt, $usage) = describe_options("rast-call-features-rRNA-SEED %o < input > output",
				    @options);
