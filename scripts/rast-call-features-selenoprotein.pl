...
rast-call-features-selenoprotein [--input genome-file] [--output genome-file] [< genome-file] [> genome-file]
...
rast-call-features-selenoprotein [-hio] [long options...] < input > output
