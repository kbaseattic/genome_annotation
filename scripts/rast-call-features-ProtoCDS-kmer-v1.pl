...
rast2-call-features-ProtoCDS-kmer-v1

=head1 SYNOPSIS

rast2-call-features-ProtoCDS-kmer-v1 [--input genome-file] [--output genome-file] [< genome-file] [> genome-file]
...
my($opt, $usage) = describe_options("rast2-call-features-ProtoCDS-kmer-v1 %o < input > output",
				    @options);
...
my $genome_out = $client->call_features_ProtoCDS_kmer_v1($genome_in, get_params_for_kmer_v1($opt));
