...
rast-call-features-ProtoCDS-kmer-v1

=head1 SYNOPSIS

rast-call-features-ProtoCDS-kmer-v1 [--input genome-file] [--output genome-file] [< genome-file] [> genome-file]
...
my($opt, $usage) = describe_options("rast-call-features-ProtoCDS-kmer-v1 %o < input > output",
				    @options);
