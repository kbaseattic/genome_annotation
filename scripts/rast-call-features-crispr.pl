...
rast2-call-features-crispr

=head1 SYNOPSIS

rast2-call-features-crispr [--input genome-file] [--output genome-file] [< genome-file] [> genome-file]
...
rast2-call-features-crispr [-hio] [long options...] < input > output
...
my($opt, $usage) = describe_options("rast2-call-features-crispr %o < input > output",
				    @options);
